...
PCB 采用 **4 层、1.6 mm 板厚、1 oz 铜厚**设计，常用阻容器件全部采用 0805 封装，便于焊接。板卡正面主要布置主功率变压器，背面主要布置驱动、控制和采样电路。
...
- ST-Link V2；
- USB 转 TTL 模块（3.3 V 电平）；
- SH1.0 转 2.54 mm 转接板；
- SH1.0 接口连接线。

![烧录所需设备](Docs/准备设备.png)

在电脑中下载安装 [STM32 ST-LINK Utility](https://www.st.com/en/development-tools/stsw-link004.html)，并建议先[下载当前工程（ZIP）](https://github.com/AzidoPP/HVCCPS-V1.4/archive/refs/heads/main.zip)，以便离线使用烧录页面和查阅资料。
...
> [!WARNING]
> 操作前必须断开高压输出负载。USB 转 TTL 模块必须使用 3.3 V 逻辑电平，并注意避免多路电源同时供电。
