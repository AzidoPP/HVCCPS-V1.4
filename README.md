...
> [!NOTE]
> 表中的 28 V 是推荐工作范围上限，母线电容耐压为35V，切勿超过35V。
...
如需更高输出电压，必须重新核算并验证变压器匝比、整流二极管、输出电容、反馈网络，同时修改固件参数。本PCB布局设计安全上限为7000V，如需改版，切勿超过7000V。
...
| R24–R28 | Viking（光颉）高压电阻（[参考链接](https://item.taobao.com/item.htm?id=987002402599)） | — |
...
[观看电容恒流充电测试视频](https://github.com/AzidoPP/HVCCPS-V1.4/releases/download/videos-v1.4/HVCCPS-V1.4-Capacitor-CC-Charging-Test.mp4)
...
[观看阻性负载恒压测试视频](https://github.com/AzidoPP/HVCCPS-V1.4/releases/download/videos-v1.4/HVCCPS-V1.4-Resistive-CV-Test.mp4)

测试将 5 kΩ 铝壳电阻连接至输出端，并将输出电压设定为 800 V。测试过程中输出电压保持稳定，用于验证恒压环路及持续输出能力。

### 7.4 拉弧测试

[观看拉弧测试视频](https://github.com/AzidoPP/HVCCPS-V1.4/releases/download/videos-v1.4/HVCCPS-V1.4-Arc-Test.mp4)
